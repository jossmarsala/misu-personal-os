...
/**
 * Get array of 7 days starting from a given date (defaults to Monday of current week)
 */
export function getWeekDays(date = null) {
  const startDay = date ? new Date(date) : getStartOfWeek(new Date());
